	...
	<div class="container">
		...
		<div class="navbar-header">
			...
			<a href="#" class="navbar-brand">
				<img style="width: 250px;" src="images/GeekLimits_logo_3_transplants.png">
			</a>
		</div>
		<nav class="collapse navbar-collapse" id="rock-navigation">
			<ul class="nav navbar-nav navbar-right main-navigation text-uppercase">
				...
				<%--<li><a href="javascript:void(0)" onclick="scrollNow('home')">Home</a></li>--%>
				<%--<li><a href="javascript:void(0)" onclick="scrollNow('work')">Our Force</a></li>--%>
				<%--<li><a href="javascript:void(0)" onclick="scrollNow('portfolio')">Recent Evaluation</a></li>--%>
				<%--<li><a href="javascript:void(0)" onclick="scrollNow('resume')">Useful Skills</a></li>--%>
				<%--<li><a href="javascript:void(0)" onclick="scrollNow('about')">About</a></li>--%>
				<%--<li><a href="javascript:void(0)" onclick="scrollNow('contact')">Contact</a></li>--%>
			</ul>
		</nav>
