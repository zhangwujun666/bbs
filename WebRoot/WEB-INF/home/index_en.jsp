			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					<a href="#" class="navbar-brand">
						<img style="width: 250px;" src="front/images/GeekLimits_logo_3_transplants.png">
					</a>
				</div>
				<nav class="collapse navbar-collapse" id="rock-navigation">
					<ul class="nav navbar-nav navbar-right main-navigation text-uppercase">
						<li><a href="#home" class="smoothScroll">Home</a></li>
						<li><a href="#work" class="smoothScroll">Our Force</a></li>
						<li><a href="#portfolio" class="smoothScroll">Recent Evaluation</a></li>
						<li><a href="#resume" class="smoothScroll">Useful Skills</a></li>
						<li><a href="#about" class="smoothScroll">About</a></li>
						<li><a href="#contact" class="sy-fanhui">Contact</a></li>
					</ul>
				</nav>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-8 col-sm-10">
						...
						<h2 class="tm-home-subtitle">Can Find Really Laptop Information</h2>
						<p>A website you can find <strong>Really Useful Laptop Information</strong> and <strong>Some Apple—End Information. </strong> You can chat with others to <strong>Share</strong> and <strong>Learn </strong>Some new skills. Be better.</p> <br ><p> Thank you :D</p>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-offset-1 col-md-11">
						<h2 class="title">Our Force<strong> Work</strong></h2>
					</div>
					<div class="col-md-4 col-sm-4">
						<div class="work-wrapper">
							<i class="fa fa-laptop"></i>
							<h3 class="text-uppercase tm-work-h3">Laptop</h3>
							<hr>
							<p>At here, you can find many useful information for your purchase.</p><p> Of course you can compare all data what you want easily.</p>
						</div>
					</div>
					<div class="col-md-4 col-sm-4">
						<div class="work-wrapper">
							...
							<hr>
							<p>MacBook . MacBook Pro . iMac </p><p>For all of those devices you can share your own thinking and chat with others for new skills.</p>
						</div>
					</div>
					<div class="col-md-4 col-sm-4">
						<div class="work-wrapper">
							<i class="fa fa-wrench"></i>
							<h3 class="text-uppercase tm-work-h3">Useful Tips</h3>
							<hr>
							<p>Any articles and tips are very useful for daily work or study</p><p>Those can help you be better and more effective. </p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 wow bounce">
						<div class="title">
							<h2 class="tm-portfolio-title">Recent <strong> Evaluation</strong></h2>
						</div>
								...
								<div class="iso-box-wrapper col4-iso-box">
									<div class="iso-box html photoshop wordpress mobile col-md-3 col-sm-3 col-xs-12">
										<div class="portfolio-thumb">
											<img src="front/images/portfolio-img1.jpg" class="fluid-img" alt="portfolio img">
									...
									<div class="iso-box html wordpress mobile col-md-3 col-sm-3 col-xs-12">
										<div class="portfolio-thumb">
											<img src="front/images/portfolio-img2.jpg" class="fluid-img" alt="portfolio img">
											<div class="portfolio-overlay">
												<h3 class="portfolio-item-title">UX Design</h3>
												<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonumm.</p>
											</div>
									...
									<div class="iso-box wordpress col-md-3 col-sm-3 col-xs-12">
										<div class="portfolio-thumb">
											<img src="front/images/portfolio-img3.jpg" class="fluid-img" alt="portfolio img">
											<div class="portfolio-overlay">
												<h3 class="portfolio-item-title">UX Design</h3>
												<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonumm.</p>
											</div>
									...
									<div class="iso-box html mobile col-md-3 col-sm-3 col-xs-12">
										<div class="portfolio-thumb">
											<img src="front/images/portfolio-img4.jpg" class="fluid-img" alt="portfolio img">
											<div class="portfolio-overlay">
												<h3 class="portfolio-item-title">UX Design</h3>
												<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonumm.</p>
											</div>
									...
									<div class="iso-box wordpress col-md-3 col-sm-3 col-xs-12">
										<div class="portfolio-thumb">
											<img src="front/images/portfolio-img5.jpg" class="fluid-img" alt="portfolio img">
											<div class="portfolio-overlay">
												<h3 class="portfolio-item-title">UX Design</h3>
												<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonumm.</p>
											</div>
									...
									<div class="iso-box html photoshop col-md-3 col-sm-3 col-xs-12">
										<div class="portfolio-thumb">
											<img src="front/images/portfolio-img6.jpg" class="fluid-img" alt="portfolio img">
											<div class="portfolio-overlay">
												<h3 class="portfolio-item-title">UX Design</h3>
												<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonumm.</p>
											</div>
									...
									<div class="iso-box photoshop col-md-3 col-sm-3 col-xs-12">
										<div class="portfolio-thumb">
											<img src="front/images/portfolio-img7.jpg" class="fluid-img" alt="portfolio img">
											<div class="portfolio-overlay">
												<h3 class="portfolio-item-title">UX Design</h3>
												<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonumm.</p>
											</div>
									...
									<div class="iso-box wordpress col-md-3 col-sm-3 col-xs-12">
										<div class="portfolio-thumb">
											<img src="front/images/portfolio-img8.jpg" class="fluid-img" alt="portfolio img">
											<div class="portfolio-overlay">
												<h3 class="portfolio-item-title">UX Design</h3>
												<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonumm.</p>
											</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-offset-6 col-md-6 col-sm-offset-6 col-sm-7" style="margin-left: 0%; color: white;">
						<div class="title">
							<h2 style="color: #e0e0e0">This is <strong>me</strong></h2>
